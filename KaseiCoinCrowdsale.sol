...
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale { // UPDATE THE CONTRACT SIGNATURE TO ADD INHERITANCE
    ...
    constructor(
        ...
        KaseiCoin token // the KaseiCoin itself that this will work with
...
contract KaseiCoinCrowdsaleDeployer {
    ...
    constructor(
        ...
        // YOUR CODE HERE!
        KaseiCoinCrowdsale coin_sale = new KaseiCoinCrowdsale(1, wallet, token);
            
        // Aassign the `KaseiCoinCrowdsale` contract’s address to the `kasei_crowdsale_address` variable.
        // YOUR CODE HERE!
        kasei_crowdsale_address = address(coin_sale);
